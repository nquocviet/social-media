...
const Tooltip = ({
  ...
  const tooltipClassName = cx(
    'absolute bg-black text-white text-left text-sm px-3 py-1.5 whitespace-nowrap rounded opacity-0 invisible transition-all group-hover:opacity-100 group-hover:delay-300 group-hover:visible',
